...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<script type="text/javascript" src="<?= EDESKTOP_URL_JS ?>/jquery.loader-1.0.3.js"></script>
		<script type="text/javascript" src="<?= EDESKTOP_URL_JS ?>/jquery-ui-1.8rc2.custom.min.js"></script>
		
		<script type="text/javascript">
		
			window.eDesktop = {
				template : '<?= EDESKTOP_TEMPLATE; ?>',	
				url : '<?= EDESKTOP_URL; ?>'			
			}
	...
	<body style="background: url(<?= EDESKTOP_URL_IMG ?>/wallpaper.jpg) center center no-repeat;">
	</body>
</html>
