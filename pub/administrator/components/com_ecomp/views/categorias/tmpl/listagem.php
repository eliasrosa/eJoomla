...
<form action="index.php" method="post" name="adminForm">
	<div id="editcell">
		...
		<br /><span style="color: #AAA;"><a href="index.php?option=com_ecomp&view=cadastros&idcomponente=<?= $idcomponente ?>">Cadastros</a> | <a href="index.php?option=com_ecomp&view=tags&idcomponente=<?= $idcomponente ?>">Tags</a></span>
	</div>
