...
function multiUpload(id, filesdiv, options)
{
	...
	this.createBaseHtml = function()
	{
		...
		html += '<div class="c100 ac bold">Remover</div><div class="c30p bold">Progresso</div></div><div class="sep"></div>';
	...
	this.onSelected = function(e)
	{
		for (var i = 0; i < e.files.length; i++)
		{
			...
			divfile.innerHTML = '<div class="c30p">'+info.name+'</div><div class="c100 ac">'+size(info.size)+'</div><div class="c100 remover"><a href="javascript:'+id+'.cancelUpload('+info.id+');"><span>X</span></a></div><div class="c30p progress"><div id="progress_'+info.id+'">&nbsp;</div></div><div class="sep"></div>';
