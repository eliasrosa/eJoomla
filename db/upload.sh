...
echo "  - Exportando o banco de dados do servidor $HOST_LOCAL"
$MYSQL_DIR/mysqldump.exe --default-character-set=utf8 --host=$HOST_LOCAL --user=$USER_LOCAL --password=$PASS_LOCAL $BANC_LOCAL > $FILE_NAME
